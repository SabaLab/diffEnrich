...
#' @param findFile logical. If TRUE, look for existing kegg pull file named
#' in fileName in the directory provided in dirToLook. Default = FALSE.
#' @param fileName character. The name of any one of the 3 files generated by this
#' function.
#' @param dirToLook character. Expected path to file name in fileName.
#' @param ... additional arguments to pass to reader::find.file
#'

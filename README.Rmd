...
elpos <- coordinates (c(1, 1, 2, 2, 1, 1, 1, 1))
...
for (i in 1:nr){
  ...
  textrect(elpos[1,], 0.10, 0.03, lab = "get_kegg()", box.col = "steelblue1",
              shadow.col = "darkblue", shadow.size = 0.005, cex = 1.0)
  textround(elpos[2,], 0.10, 0.03,lab = "KEGG REST API", box.col = "orange1",
            shadow.col = "orange4", shadow.size = 0.005, cex = 1.0)
  textrect(elpos[3,], 0.10, 0.03,lab = "pathEnrich(List 1)", box.col = "steelblue1",
            shadow.col = "darkblue", shadow.size = 0.005, cex = 1.0)
  textrect(elpos[4,], 0.10, 0.03, lab = "pathEnrich(List 2)", box.col = "steelblue1",
           shadow.col = "darkblue", shadow.size = 0.005, cex = 1.0)
  textellipse(elpos[5,], 0.10, 0.04, lab = c("pathEnrich","result/object"), box.col = "firebrick1",
              shadow.col = "firebrick4", shadow.size = 0.005, cex = 1.0)
  textellipse(elpos[6,], 0.10, 0.04, lab = c("pathEnrich","result/object"),box.col = "firebrick1",
              shadow.col = "firebrick4", shadow.size = 0.005, cex = 1.0)
  textrect(elpos[7,], 0.10, 0.03, lab = "diffEnrich()", box.col = "steelblue1",
           shadow.col = "darkblue", shadow.size = 0.005, cex = 1.0)
  textellipse(elpos[8,], 0.10, 0.04, lab = c("diffEnrich","result/object"), box.col = "firebrick1",
              shadow.col = "firebrick4", shadow.size = 0.005, cex = 1.0)
  textrect(elpos[9,], 0.11, 0.03, lab = "plotFoldEnrichment", box.col = "steelblue1",
           shadow.col = "darkblue", shadow.size = 0.005, cex = 1.0)
  text(0.2,0.95, "Figure 1. diffEnrich Analysis pipeline", cex = 0.75)
}
```

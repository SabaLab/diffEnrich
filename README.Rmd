...
integrating data retrevial into user's code makes the program reproducible. To 
...
data sets in different directories if they so choose. Additionaly, *get_kegg* can be used to read in saved versions of the txt files
...
description <- c("KEGG Pathway Identifier",
                 ...
                 "Multiple testing adjusted enrichment p-values (default = False Discovery Rate (Benjamini and Hochberg))",
...
for multiple testing adjustment. Users can choose from those supported by *stats::p.adjust*. The default is the False Discovery Rate ( [Benjamini and Hochberg, 1995](http://www.jstor.org/stable/2346101)).
...
de_col_descr <- c("KEGG Pathway Identifier",
                  ...
                  "Multiple testing adjusted enrichment p-values from gene list 1 (default = False Discovery Rate (Benjamini and Hochberg))",
                  ...
                  "Multiple testing adjusted enrichment p-values from gene list 2 (default = False Discovery Rate (Benjamini and Hochberg))",
                  ...
                  "Multiple testing adjusted differential enrichment p-values (default = False Discovery Rate (Benjamini and Hochberg))")
# Make dataframe
...
the number of pathways that were shared (i.e. had at least 1 gene from each gene list present in the pathway) between the gene lists and the
method used for multiple testing correction.
...
**Figure 2.** Fold enrichment stratified by gene list. KEGG pathways are plotted on the y-axis and fold
enrichment is plotted on the x-axis. Each KEGG pathway has a bar depicting
its fold enrichment in list 1 (red) and its fold enrichment in list 2 (blue).
The transparency of the bars correspond to the unadjusted p-value for the
pathway's enrichment in the given list. The p-value presented as text to the

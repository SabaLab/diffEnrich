...
intended to be used in a pipeline (See Figure 1). Briefly, the workflow will
...
```{r, echo=FALSE, fig.cap='Figure 1. diffEnrich analysis pipeline.', dpi=400}
...
```{r plotFoldEnrichment, dpi=400, message=FALSE}

...
[![AppVeyor build status](https://ci.appveyor.com/api/projects/status/github/SabaLab/diffEnrich?branch=master&svg=true)](https://ci.appveyor.com/api/github/webhook?id=ocnarj9n9qj7xncf)
...
up-t-date versions of the data contained in the data base. In addition, accessing the
...
Functional enrichment of carbonylated proteins for KEGG pathways and was tested 
...
and the associated p-value. Users can choose from those supported by *stats::p.adjust*, and the default is the False Discovery Rate (Benjamini and Hochberg).

...
description <- c("KEGG Pathway Identifier",
                 ...
                 "Ratio of number of genes observed from the gene list annotated to the KEGG pathay to the number og genes expected from the gene list annotated to the KEGG pathway if ther was no enrichment (i.e. KEGG_PATHWAY_in_list/expected)")
# Make dataframe

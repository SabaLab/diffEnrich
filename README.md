...
et al., 2005](https://www.pnas.org/content/102/43/15545)) as well as a
wide variety of databases used to define these pathways (e.g., [Kanehisa
and Goto, 2000](https://www.ncbi.nlm.nih.gov/pubmed/10592173)) and
ontologies (e.g., [Ashburn et
...
particular modified proteins between treatment groups.
...
#> Kegg Release: Release_92.0+_10-11_Oct_19
```
...
columns described below. Details also provided in *pathEnrich*
documentation as well as other metadata from the function call. Use
*?pathEnrich*. S3 generic functions for *print* and *summary* are
...
genes used from the KEGG data base, the KEGG species, and the method
...
and the *summary* function returns the number of pathways that reached
statistical significance as well as their descriptions, the number of
genes used from the KEGG data base, the KEGG species, the number of
pathways that were shared (and therefore tested) between the gene lists
and the method used for multiple testing correction.
